...
public class IngredientTM implements Comparable<IngredientTM>{
    ...
    public IngredientTM(String ingCode, String des, String unit, double qty, String date) {
    ...
    @Override
    public int compareTo(IngredientTM o) {
