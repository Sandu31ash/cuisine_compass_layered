...
public class MainCourseFormController implements Initializable {
    ...
    private void loadRecipes() throws SQLException, ClassNotFoundException {
        ...
        ArrayList<RecipeDTO> recipes = recipeBO.getAllRecipeApp("Main Course");
    ...
    public void btnBackMainOnAction(ActionEvent actionEvent) throws IOException {
