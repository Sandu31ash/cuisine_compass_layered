...
public class LunchMenuFormController implements Initializable {
    @FXML
    private Button btnBackLunch;
    ...
    /*void getAllApp() {
        try {
            ...
            List<Menu> menuList = MenuModel.getAllApp("lunch");
    ...
    private void getAllApp() {
        try {
            ...
            List<MenuDTO> menuList = menuBO.getAllApp("Appertizer", "lunch");
    ...
    /*void getAllSoup() {
        try {
            ObservableList<MenuTM> obList = FXCollections.observableArrayList();
            List<Menu> menuList = MenuModel.getAllSoup("lunch");
    ...
    private void getAllSoup() {
        try {
            ...
            List<MenuDTO> menuList = menuBO.getAllApp("Soup/Salad", "lunch");
    ...
    /*void getAllMain() {
        try {
            ObservableList<MenuTM> obList = FXCollections.observableArrayList();
            List<Menu> menuList = MenuModel.getAllMain("lunch");
    ...
    private void getAllMain() {
        try {
            ...
            List<MenuDTO> menuList = menuBO.getAllApp("Main Course", "lunch");
    ...
    /*void getAllDessert() {
        try {
            ObservableList<MenuTM> obList = FXCollections.observableArrayList();
            List<Menu> menuList = MenuModel.getAllDessert("lunch");
    ...
    private void getAllDessert() {
        try {
            ...
            List<MenuDTO> menuList = menuBO.getAllApp("Dessert", "lunch");
    ...
    /*void getAllBev() {
        try {
            ObservableList<MenuTM> obList = FXCollections.observableArrayList();
            List<Menu> menuList = MenuModel.getAllBev("lunch");
    ...
    private void getAllBev() {
        try {
            ...
            List<MenuDTO> menuList = menuBO.getAllApp("Beverage", "lunch");
    ...
    public void btnBackLunchOnAction(ActionEvent actionEvent) throws IOException {
