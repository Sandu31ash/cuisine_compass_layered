...
public class DessertFormController implements Initializable {
    ...
    private void loadRecipes() throws SQLException, ClassNotFoundException {
        ...
        ArrayList<RecipeDTO> recipes = recipeBO.getAllRecipeApp("dessert");
    ...
    public void btnBackDessertOnAction(ActionEvent actionEvent) throws IOException {
