...
public class BeverageFormController implements Initializable {
    ...
    private void loadRecipes() throws SQLException, ClassNotFoundException {
        ...
        //List<String> recipes = RecipeModel.getRecipeBev();

        ArrayList<RecipeDTO> recipes = recipeBO.getAllRecipeApp("beverage");
    ...
    public void btnBackBevOnAction(ActionEvent actionEvent) throws IOException {
    ...
    @SneakyThrows
    public void cBoxRecipeOnAction(ActionEvent event) throws SQLException {
        getAllRCode();
        getMethod();
        setCellValueFactory();
